...
def main():
    ...
    # TODO: Create a val_data with flag="train" and val_loader for validation
    # TODO: Change data_range so that train_data and val_data splits the 906 samples under "train" folder. You can decide how to split.
